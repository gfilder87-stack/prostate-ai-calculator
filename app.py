...
if st.session_state.show_results:
    ...
    if models_over_threshold >= 5:
        st.error(f"🔴 **СИГНАЛ ЗА БИОПСИЯ (Консенсус: {models_over_threshold} от 8 модела)**\n\nМнозинството алгоритми класифицират пациента **над безопасния праг**. Препоръчва се извършване на биопсия, за да се предотврати пропускане на клинично значим карцином.")
